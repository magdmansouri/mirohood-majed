...
<body class="auth-page">
    ...
    <div class="auth-box">
        ...
        <div class="subtitle">ورود به حساب کاربری</div>
        ...
        <form method="POST" action="">
            ...
            <input type="tel" name="phone" placeholder="شماره موبایل" required autofocus value="<?php echo h($_POST['phone'] ?? ''); ?>">
        ...
        <div class="footer" style="margin-bottom:0.75rem;">
            <a href="<?php echo url('forgot-password'); ?>">رمز عبور را فراموش کرده‌اید؟</a>
        </div>
        <div class="footer">
            حساب کاربری ندارید؟
            <a href="<?php echo url('register?redirect=' . urlencode($redirect)); ?>">ثبت‌نام کنید</a>
        </div>
    </div>
    <script>
