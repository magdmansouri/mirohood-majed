...
<head>
    ...
    <title>بازیابی رمز عبور | Mirohood</title>
...
<body class="auth-page">
    ...
    <div class="auth-box">
        ...
        <div class="subtitle">بازیابی رمز عبور</div>
        ...
        <?php if (empty($success)): ?>
            <form method="POST" action="">
                ...
                <div class="hint">اگر برای حساب شما ایمیل ثبت شده باشد، لینک بازیابی رمز عبور به آن ارسال می‌شود.</div>

                <button type="submit">
                    <i class="fas fa-paper-plane" style="margin-left:0.4rem;"></i>
                    ارسال لینک بازیابی
                </button>
            </form>
        <?php endif; ?>
        ...
        <div class="footer">
            <a href="<?php echo url('login'); ?>">بازگشت به صفحه ورود</a>
        </div>
    </div>
    <script>
